...
public class UiController {
    ...
    private static RunRequest copyRequest(RunRequest source) {
        ...
        target.setOpenAiTimeoutSeconds(source.getOpenAiTimeoutSeconds());
        target.setOpenAiMaxRetries(source.getOpenAiMaxRetries());
        target.setOpenAiRetryBackoffSeconds(source.getOpenAiRetryBackoffSeconds());
        target.setOpenAiMaxTokens(source.getOpenAiMaxTokens());
        target.setOpenAiThinkingType(source.getOpenAiThinkingType());
        ...
        target.setEnableImageConsul(source.getEnableImageConsul());
        target.setImageModel(source.getImageModel());
        target.setImageCount(source.getImageCount());
        target.setImageSize(source.getImageSize());
        target.setImagePollIntervalSeconds(source.getImagePollIntervalSeconds());
        target.setImagePollTimeoutSeconds(source.getImagePollTimeoutSeconds());
